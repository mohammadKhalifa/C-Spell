#############################################################################
# Makefile for building: c_spell
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  c-spell.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 -o Makefile c-spell.pro
#############################################################################
...
Makefile: c-spell.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 -o Makefile c-spell.pro
...
dist: 
	@test -d .tmp/c_spell1.0.0 || mkdir -p .tmp/c_spell1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents edit_distance.h mainwindow.h wordbreaker.h lexicon.h about.h .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents wordbreaker.cpp mainwindow.cpp edit_distance.cpp main.cpp lexicon.cpp about.cpp .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents mainwindow.ui about.ui .tmp/c_spell1.0.0/ && (cd `dirname .tmp/c_spell1.0.0` && $(TAR) c_spell1.0.0.tar c_spell1.0.0 && $(COMPRESS) c_spell1.0.0.tar) && $(MOVE) `dirname .tmp/c_spell1.0.0`/c_spell1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/c_spell1.0.0
...
moc_about.cpp: /usr/include/qt5/QtWidgets/QDialog \
		...
		/usr/include/qt5/QtGui/qtouchdevice.h \
		about.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include about.h -o moc_about.cpp
...
wordbreaker.o: wordbreaker.cpp wordbreaker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o wordbreaker.o wordbreaker.cpp
...
edit_distance.o: edit_distance.cpp edit_distance.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o edit_distance.o edit_distance.cpp
