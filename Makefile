...
SOURCES       = wordbreaker.cpp \
		...
		edit_distance.cpp \
		main.cpp \
		lexicon.cpp moc_mainwindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents edit_distance.h mainwindow.h wordbreaker.h lexicon.h .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents wordbreaker.cpp mainwindow.cpp edit_distance.cpp main.cpp lexicon.cpp .tmp/c_spell1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/c_spell1.0.0/ && (cd `dirname .tmp/c_spell1.0.0` && $(TAR) c_spell1.0.0.tar c_spell1.0.0 && $(COMPRESS) c_spell1.0.0.tar) && $(MOVE) `dirname .tmp/c_spell1.0.0`/c_spell1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/c_spell1.0.0
